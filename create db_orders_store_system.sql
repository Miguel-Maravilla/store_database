...
ALTER TABLE order_item_notes ADD FOREIGN KEY (order_id) REFERENCES orders(order_id);
ALTER TABLE order_item_notes ADD FOREIGN KEY (product_id) REFERENCES products(product_id);